            ...
            {data.campaigns.length ? (
              <div className="table-scroll">
                <table className="admin-table">
                  <thead><tr><th>Campagne</th><th>Canal</th><th>Statut</th><th>Sessions</th><th>Conversions</th><th>Revenu</th></tr></thead>
                  <tbody>{data.campaigns.map((campaign) => (
                    <tr key={campaign.id}>
                      <td><strong>{campaign.name}</strong><small>{campaign.utmCampaign}</small></td>
                      <td>{campaign.channel}</td>
                      <td><span className={`status-tag is-${campaign.status}`}>{campaign.status}</span></td>
