...
describe('OdooService', () => {
  ...
  it('defaults to port 443 for an Odoo Online https URL without an explicit port', async () => {
    const service = new OdooService(
      createConfig({ ODOO_URL: 'https://edu-mdgnsignature.odoo.com' }),
      factory,
    );
    ...
    expect(factory).toHaveBeenCalledWith({
      baseUrl: 'https://edu-mdgnsignature.odoo.com',
      port: 443,
      db: 'imana',
      username: 'admin',
      password: 'secret',
